...
public class DateRangeAttribute : ValidationAttribute, IClientModelValidator
{
    ...
    public DateRangeAttribute(int yearsAgoStart, int yearsAgoEnd)
    {
        _minDate = DateOnly.FromDateTime(DateTime.Now.AddYears(-yearsAgoStart));
        _maxDate = DateOnly.FromDateTime(DateTime.Now.AddYears(-yearsAgoEnd));
    }
